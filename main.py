    ...
    while True: # boucle principale du jeu
        ...
        if game_active:
            ...
            if snail_rect.right < 0:
                snail_rect.left = 805
            if snail_rect.right % 20 < 10: 
                snail = snail_surface_1
            else:
                snail = snail_surface_2
            ...
            # collision detection : colliderect and collidepoint
            if player_rect.colliderect(snail_rect): # no collision 0, there is a collision 1
                game_active = False
                # pygame.mouse.get_pressed() to get mouse click
