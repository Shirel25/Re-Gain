...
class InputManager:
    ...
    def update(self, events=None):
        ...
        if self.mode == "keyboard":
            ...
            # Although K-means is used upstream to learn user-specific
            # activation levels (REST / ACTIVE / OVERLOAD),
            # the final movement control relies on the continuous
            # arm activation signal (arm_act).
            #
            # This choice ensures smooth, responsive interaction
            # and avoids rigid, threshold-based control.
